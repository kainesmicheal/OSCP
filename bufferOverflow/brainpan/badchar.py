...
for n in range (init, rango):
	if badchars[n] == buff[n-init].upper():
		print bcolors.OKGREEN + badchars[n] + " : " + buff[n-init].upper() + bcolors.ENDC + " | ",
	else:
		print bcolors.FAIL + badchars[n] + " : " + buff[n-init].upper() + bcolors.ENDC + " | ",
